...
<head>
    ...
    <style>
        #body{
            background-image: url('img/Image.jpeg'); /* Make sure this path is correct */
            background-size: cover; /* Ensures it covers the whole div */
            background-repeat: no-repeat;
            background-position: center;
            min-height: 500px; /* Optional: adjust based on your layout */
        }
    </style>
</head>
<body>
<div id="full">
    <div id="inner_full">
        <div id="header"><h2 align="center">JEVANDAN-Blood Bank Management System</h2></div>
        <div id="body">
            <br><br><br><br><br>
        ...
        <div id="footer"><h4 align="center">Copyright@JEVANDAN</h4></div>
    </div>
</div>
</body>
</html>